...
if tab == "Capacidad SURF":
    ...
    default_stations = [
        {"name": "Encintado", "icon": "🟦", "color": "#1f3b6f",
         "machines": [
            {"type": "Encintadora Automática", "count": 1, "capacity": 1200},
            {"type": "Encintado Manual", "count": 1, "capacity": 0}]},
        {"name": "Bloqueo Digital", "icon": "🟩", "color": "#27ae60",
         "machines": [{"type": "PRA", "count": 3, "capacity": 600}]},
        {"name": "Generado Digital", "icon": "🟫", "color": "#8d6748",
         "machines": [{"type": "Orbit", "count": 3, "capacity": 550}]},
        {"name": "Laser", "icon": "🟨", "color": "#f7e017",
         "machines": [
            {"type": "Automático", "count": 1, "capacity": 800},
            {"type": "Manual", "count": 1, "capacity": 900}]},
        {"name": "Pulido", "icon": "🟪", "color": "#7d3fc7",
         "machines": [
            {"type": "Duo Flex", "count": 2, "capacity": 240},
            {"type": "DLP", "count": 6, "capacity": 220}]},
        {"name": "Desbloqueo", "icon": "⬛", "color": "#222222",
         "machines": [
            {"type": "Manual", "count": 1, "capacity": 3300},
            {"type": "Desblocker", "count": 1, "capacity": 2800}]},
        {"name": "Calidad", "icon": "⬜", "color": "#eaeaea",
         "machines": [
            {"type": "Foco Vision", "count": 1, "capacity": 420},
            {"type": "Promapper", "count": 1, "capacity": 800}]}
    ]
    stations = []
    ...
    default_stations_em = [
        {"name": "Anaquel", "icon": "🔲", "color": "#8e44ad",
         "machines": [{"type": "Manual", "count": 1, "capacity": 720}]},
        {"name": "Bloqueo", "icon": "🟦", "color": "#2980b9",
         "machines": [{"type": "Manual", "count": 1, "capacity": 600}]},
        {"name": "Corte", "icon": "✂️", "color": "#27ae60",
         "machines": [
            {"type": "Bisphera", "count": 1, "capacity": 109},
            {"type": "ES4", "count": 2, "capacity": 34},
            {"type": "MEI641", "count": 1, "capacity": 74}]},
        {"name": "Remate", "icon": "🟨", "color": "#f4d03f",
         "machines": [{"type": "Manual", "count": 1, "capacity": 60}]}
    ]
    stations_em = []
    ...
    capacidad_surf = st.sidebar.number_input("Capacidad base SURF (lentes/turno)", min_value=1, value=1200, key="ta_csurf")
    ...
    capacidad_ar = st.sidebar.number_input("Capacidad base AR (lentes/turno)", min_value=1, value=1100, key="ta_car")
    ...
    capacidad_em = st.sidebar.number_input("Capacidad base Montaje (lentes/turno)", min_value=1, value=1500, key="ta_cem")
